...
<button @click="$emit('end')">END EXAM</button>
<div class="h-36 border border-borderclr rounded-2xl bg-cardclr">
    <div class="grid grid-cols-1 gap-10 py-14 px-8 text-white" v-if="exam">
